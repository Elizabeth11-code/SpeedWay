...
Piston1.set(!Piston1.value());

});

Controller1.ButtonB.pressed([]{
Piston2.set(!Piston2.value());
...
TM.set(!TM.value());
    ...
    switch(current_auton_selection){
      case 0:
        Brain.Screen.printAt(5, 140, "RIGHT SIDE AUTON");
        break;
      case 1:
        Brain.Screen.printAt(5, 140, " LEFT SIDE AUTON");
        break;
      case 2:
      ...
      case 7:
        ...
        break;
      case 8:
        Brain.Screen.printAt(5, 140, "AutonRedRt");
        break;
    }
